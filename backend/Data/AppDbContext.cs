...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Paciente>().HasData(
            new Paciente { Id = 1, NombreCompleto = "Gonzalo Herrera",   DNI = "28445123", Email = "gonzalo.herrera@gmail.com",    Telefono = "1145678901", FechaBloqueo = null,                     createdAt = new DateTime(2026, 1, 4),      isActive = true },
            new Paciente { Id = 2, NombreCompleto = "Mariana López",     DNI = "31202456", Email = "mariana.lopez@hotmail.com",    Telefono = "1167891234", FechaBloqueo = null,                     createdAt = new DateTime(2026, 1, 24),     isActive = true },
            new Paciente { Id = 3, NombreCompleto = "Roberto Quintana",  DNI = "25789012", Email = "roberto.q@gmail.com",          Telefono = "1156789012", FechaBloqueo = null,                     createdAt = new DateTime(2026, 2, 23),     isActive = true },
            new Paciente { Id = 4, NombreCompleto = "Sofía Vargas",      DNI = "35123789", Email = "sofia.vargas@yahoo.com",       Telefono = "1178901234", FechaBloqueo = null,                     createdAt = new DateTime(2026, 3, 10),     isActive = true },
            new Paciente { Id = 5, NombreCompleto = "Diego Fernández",   DNI = "29876543", Email = "diegofernandez@gmail.com",     Telefono = "1134567890", FechaBloqueo = null,                     createdAt = new DateTime(2026, 3, 25),     isActive = true },
            new Paciente { Id = 6, NombreCompleto = "Laura Giménez",     DNI = "33456789", Email = "lauragimenez@gmail.com",       Telefono = "1189012345", FechaBloqueo = null,                     createdAt = new DateTime(2026, 4, 4),      isActive = true },
            new Paciente { Id = 7, NombreCompleto = "Facundo Sosa",      DNI = "27345678", Email = "facundo.sosa@outlook.com",     Telefono = "1112345678", FechaBloqueo = new DateTime(2026, 4, 19), createdAt = new DateTime(2025, 10, 27), isActive = true },
            new Paciente { Id = 8, NombreCompleto = "Carolina Méndez",   DNI = "36901234", Email = "carolina.mendez@gmail.com",    Telefono = "1190123456", FechaBloqueo = null,                     createdAt = new DateTime(2026, 4, 14),     isActive = true }
        );
